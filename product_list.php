  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
      <div class="list_box">
		...
		<?php foreach($posts as $row){ ?><div class="col-sm-4 col-md-3 col-mm-6 product_img"> <a href="/product<?php echo $row['typeid']; ?>/id<?php echo $row['id']; ?>"><img src="<?php echo $row['litpic']; ?>" style="width: 261px;" class="opacity_img" alt="<?php echo $row['title']; ?>"></a><p class="product_title"><a href="/product<?php echo $row['typeid']; ?>/id<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a></p></div>
        <?php } ?></div><div class="cl"></div>
