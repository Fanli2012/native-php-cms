...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`flcms` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `fl_arctype`(`id`,`reid`,`addtime`,`typename`,`seotitle`,`keywords`,`description`,`content`,`sortrank`,`typedir`,`templist`,`temparticle`,`litpic`,`seokeyword`,`model`) values (1,0,1483875789,'新闻中心','','新闻中心','新闻中心','<p>新闻中心</p>',50,'news','category','detail','/uploads/2016/10/201610100341073966.jpg','新闻中心',0),(2,0,1476063429,'案例中心','企业新闻_72pcms','企业新闻','企业新闻','<p>企业新闻</p>',50,'qiye','category','detail','','企业新闻',0),(3,1,1476063419,'行业新闻','行业新闻_72pcms','行业新闻','行业新闻','<p>行业新闻</p>',50,'hangye','category','detail','','行业新闻',0),(6,0,1483880225,'sadfad222','asdas222','dasdas222','dasd222','<p>asdasd2222</p>',50,'asd222','productlist.php','productdetail.php','','sadas222',0),(7,6,1483354984,'jkjk','jkjk','jkjk','jkjk','<p>jkjk<span style=\"box-sizing: border-box; font-weight: 700; color: rgb(51, 51, 51); font-family: &#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; background-color: rgb(249, 249, 249);\">栏目内容：</span></p>',50,'jkjk','list.php','article.php','/uploads/2016/05/201605110623012787.jpg','jkjk',0),(8,6,1483355094,'yuyu','yuyu','YUyu','yuyu','<p>yuyu</p>',50,'yuyu','list.php','article.php','','yuyu',0),(9,7,1483355114,'tyty','tyty','tyty','tytyt','<p>ytytyty</p>',50,'tyty','list.php','article.php','','tyty',0),(10,0,1483879965,'fdsaf','sdfas','dfs','sdfsa','<p>sdfsdafd</p>',50,'sdfsdfs','productlist.php','productdetail.php','','fsadf',0),(11,10,1483879982,'gsadfgas','sdfsd','fsdf','sdFZf','<p>在vgdzfgsd</p>',50,'gfdsafsd','list.php','article.php','','fsd',0),(12,0,1483880003,'sdfsd','sadfasf','sdf','sf','<p>sdfdsvxz</p>',50,'fsdafsdaf','productlist.php','productdetail.php','','saf',0);
...
insert  into `fl_friendlink`(`id`,`webname`,`url`,`group_id`) values (1,'72PCMS','http://www.72p.org/',0),(2,'炒股入门知识','http://www.pe7.org/',0),(4,'bnbni2','http://www.bnbni2.com/',0);
...
insert  into `fl_product_type`(`id`,`reid`,`addtime`,`typename`,`seotitle`,`keywords`,`description`,`content`,`sortrank`,`typedir`,`templist`,`temparticle`,`litpic`,`seokeyword`,`status`) values (1,0,1476063788,'海鲜','新闻中心_72pcms','新闻中心','新闻中心','<p>新闻中心</p>',50,'news','category','detail','/uploads/2016/10/201610100341073966.jpg','新闻中心',1),(2,0,1476063429,'零食','企业新闻_72pcms','企业新闻','企业新闻','<p>企业新闻</p>',50,'qiye','category','detail','','企业新闻',1),(3,1,1476063419,'水果','行业新闻_72pcms','行业新闻','行业新闻','<p>行业新闻</p>',50,'hangye','category','detail','','行业新闻',1),(4,1,1476068069,'咖啡','','','','<p>案例中心内容</p>',50,'case','category','detail','','',1),(5,0,1483880091,'sfdfs','fdxzgfd','Fgzxg','xcg','<p>sdfsdf</p>',50,'sdFszd','productlist.php','productdetail.php','','cxgdfg',1);
...
CREATE TABLE `fl_slide` (
  ...
  `target` smallint(1) DEFAULT '0' COMMENT '跳转方式，默认0 target,1 self',
...
insert  into `fl_slide`(`id`,`title`,`url`,`target`,`group_id`,`pic`,`rank`,`is_show`) values (1,'1','javascript:;',0,1,'/uploads/2017/01/201701081241599289.jpg',0,0),(2,'2','http://www.rouwen.net/',0,1,'/uploads/2017/01/201701081242332923.jpg',0,0);
...
insert  into `fl_user`(`id`,`username`,`email`,`logintime`,`pwd`,`role_id`) values (1,'admin888','admin@qq.com',0,'21232f297a57a5a743894a0e4a801fc3',1);
