...
$reid = $post['reid'];
if($reid!=0){ $postone = $db->find("product_type","id=$reid"); }
?>
...
<h5 class="sub-header"><a href="producttype_list.php">栏目管理</a> > 修改栏目</h5>

<form method="post" action="producttype_doedit.php" role="form" id="addcat" class="table-responsive">
