...
$where['where']="id=$id";
$row = $db->find("page",$where);
?>
<!DOCTYPE html><html><head><title>修改单页面_后台管理</title><?php include 'header.php'; ?>
<div class="container-fluid">
<div class="row">
<!-- 左边开始 --><div class="col-sm-3 col-md-2 sidebar"><?php include 'leftmenu.php'; ?></div><!-- 左边结束 -->

<!-- 右边开始 --><div class="col-sm-9 col-md-10 rightbox"><div id="mainbox">
<h5 class="sub-header"><a href="page_list.php">页面列表</a> > 新建页面</h5>

<form id="addarc" method="post" action="page_doedit.php" role="form" enctype="multipart/form-data" class="table-responsive">
