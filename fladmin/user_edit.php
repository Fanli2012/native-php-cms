...
?>
<!DOCTYPE html><html><head><title>密码修改_后台管理</title><?php include 'header.php'; ?>
...
<form id="addarc" method="post" action="user_doedit.php" class="table-responsive" role="form">
<table class="table table-striped table-bordered">
<tbody>
    <tr>
        <td align="right">用户名：</td>
        <td><input name="username" type="text" class="" id="username" value="<?php echo $row["username"]; ?>" style="width:30%"></td>
    </tr>
    <tr>
