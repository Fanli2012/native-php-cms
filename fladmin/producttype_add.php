<?php
$id = $_REQUEST["reid"];if(preg_match('/[0-9]*/',$id)){}else{exit;}
require '../common/config.php';
$db =  new db();
$where['where']="id=$id";
if($id==0){}else{ $postone = $db->find("product_type",$where); }
?>
<!DOCTYPE html><html><head><title>添加栏目_后台管理</title><?php include 'header.php'; ?>
<div class="container-fluid">
<div class="row">
<!-- 左边开始 --><div class="col-sm-3 col-md-2 sidebar"><?php include 'leftmenu.php'; ?></div><!-- 左边结束 -->

<!-- 右边开始 --><div class="col-sm-9 col-md-10 rightbox"><div id="mainbox">
<h5 class="sub-header"><a href="producttype_list.php">商品栏目管理</a> > 添加栏目</h5>

<form method="post" action="producttype_doadd.php" role="form" id="addcat" class="table-responsive">
<table class="table table-striped table-bordered">
  <tbody>
    ...
    <tr>
      ...
      <td><?php if($id==0){echo "顶级栏目";}else{echo $postone["typename"];} ?><input style="display:none;" type="text" name="reid" id="reid" value="<?php if($id==0){echo "0";}else{echo $id;} ?>"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="templist" id="templist" type="text" value="productlist.php" class="required" size="20"></td>
    </tr>
    <tr>
      <td align="right">商品模板：</td>
      <td><input name="temparticle" id="temparticle" type="text" value="productdetail.php" class="required" size="20"></td>
    </tr>
    <tr>
