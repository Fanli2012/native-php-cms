...
?>
<!DOCTYPE html><html><head><title>新建单页面_后台管理</title><?php include 'header.php'; ?>
...
<form id="addarc" method="post" action="page_doadd.php" role="form" enctype="multipart/form-data" class="table-responsive">
