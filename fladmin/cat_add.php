...
$db =  new db();
$where['where']="id=$id";
if($id==0){}else{ $postone = $db->find("arctype",$where); }
?>
...
<h5 class="sub-header"><a href="cat_list.php">栏目管理</a> > 添加栏目</h5>

<form method="post" action="cat_doadd.php" role="form" id="addcat" class="table-responsive">
<table class="table table-striped table-bordered">
  <tbody>
    ...
    <tr>
      ...
      <td><input name="templist" id="templist" type="text" value="list.php" class="required" size="20"></td>
    </tr>
    <tr>
      <td align="right">文章模板：</td>
      <td><input name="temparticle" id="temparticle" type="text" value="article.php" class="required" size="20"></td>
    </tr>
    <tr>
