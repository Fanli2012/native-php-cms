...
?>
<!DOCTYPE html><html><head><title>添加参数_后台管理</title><?php include 'header.php'; ?>
<div class="container-fluid">
<div class="row">
<!-- 左边开始 --><div class="col-sm-3 col-md-2 sidebar"><?php include 'leftmenu.php'; ?></div><!-- 左边结束 -->

<!-- 右边开始 --><div class="col-sm-9 col-md-10 rightbox"><div id="mainbox">
<h5 class="sub-header"><a href="sysconfig_list.php">系统配置参数</a> > 添加参数</h5>

<form id="addarc" method="post" action="sysconfig_doadd.php" role="form" enctype="multipart/form-data" class="table-responsive">
