...
<div class="col-sm-4 col-md-3 col-mm-6 product_img"><a href="/product<?php echo $row['typeid']; ?>/id<?php echo $row['id']; ?>"> <img src="<?php echo $row['litpic']; ?>" style="width: 261px;" class="opacity_img" alt="<?php echo $row['title']; ?>"></a><p class="product_title"><a href="/product<?php echo $row['typeid']; ?>/id<?php echo $row['id']; ?>"></a></p></div>
<?php } ?>
 </div>
      </div>
      <div class="left_nav index_left_nav" id="categories">
		...
		<li> <a class="biglink" href="http://s66.demo.s-cms.cn/html/product/list-2.html">佳能</a>            <ul class="left_snav_ul menu_body">                          </ul>          </li><li> <a class="biglink" href="http://s66.demo.s-cms.cn/html/product/list-3.html">尼康</a>            <ul class="left_snav_ul menu_body">                          </ul>          </li><li> <a class="biglink" href="http://s66.demo.s-cms.cn/html/product/list-4.html">莱卡</a>            <ul class="left_snav_ul menu_body">                          </ul>          </li>
        </ul>
      </div>
    </div>
  </div>
...
<link rel="stylesheet" type="text/css" href="<?php echo CMS_WEBSITE; ?>/css/online.css">
</body></html>